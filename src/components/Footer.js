      ...
      <div className="container">
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
          ...
          <ul className="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li className="ms-3">
              <a className="text-body-secondary" href="mailto:b23cs1059@iitj.ac.in">
            ...
            <li className="ms-3">
              <a className="text-body-secondary" target="_blank" rel="noopener noreferrer" href="https://github.com/BhargavShekokar3425/medihelppvt">
            ...
            <li className="ms-3">
              <a className="text-body-secondary" target="_blank" rel="noopener noreferrer" href="https://docs.google.com/document/d/1kaEMZjOea6FUKPANczPBNMTDgAuQ4OVyQXSo27-YeuU/edit?usp=sharing">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-file-earmark-text" viewBox="0 0 16 16">
                  <path d="M14 4.5V14a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h6.5L14 4.5zM9.5 1.5V5h3l-3-3.5zM3 6h10v1H3V6zm0 2h10v1H3V8zm0 2h7v1H3v-1z"/>
                </svg>
              </a>
            </li>
          </ul>
